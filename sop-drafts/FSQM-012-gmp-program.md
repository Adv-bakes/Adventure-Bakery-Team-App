...
**Not the controlled copy.** The controlled copy is the `FSQM-012` row in `sop_documents`;
...
Applies to all persons entering food handling, processing or storage areas at the Adventure Bakery facility — employees, temporary staff, contractors, maintenance personnel, auditors, visitors and management.
...
Food handling / contact zone — any area where product, ingredients, primary packaging or food-contact surfaces are exposed. Includes the production floor, the depositing and packing areas, and open ingredient storage.
...
SQF Practitioner / QA — owns this program, enforces it, approves exceptions, holds the risk assessments for permitted jewellery, and verifies compliance through GMP inspection.
...
**1. SCOPE AND APPLICATION OF GOOD MANUFACTURING PRACTICES (SQF 2.4.2.1, 2.4.2.2)**
...
**2. HEALTH, ILLNESS AND INJURY (SQF 11.3.1.1, 11.3.1.2, 11.3.1.3)**
...
**3. HANDWASHING (SQF 11.3.2.1 to 11.3.2.6)**
...
**4. CLOTHING, HAIR AND PROTECTIVE WEAR (SQF 11.3.3.1 to 11.3.3.7)**
...
**5. JEWELLERY AND PERSONAL EFFECTS (SQF 11.3.3.8)**
...
**6. VISITORS AND CONTRACTORS (SQF 11.3.4.1 to 11.3.4.4)**
...
**8. PROCESSING PRACTICES (SQF 11.4.1.1 to 11.4.1.4)**
...
**10. TRAINING (SQF 2.9.2.1 iii and iv, 2.4.2.2)**
...
SQF Food Safety Code: Food Manufacturing, Edition 9 — Module 11.3 (Personnel Hygiene, 11.3.1.1 to 11.3.5.10) and Module 11.4 (Personnel Processing Practices, 11.4.1.1 to 11.4.1.4).
...
New — 2026-09-01 — Initial issue. Written to close SQF 2.4.2.2, which requires the site's applicable Good Manufacturing Practices to be documented. Covers Module 11.3 and 11.4 in full — thirty-five clauses, of which SOP-11.3 addressed about nine.
...
ISSUED 2026-09-01, approved GJM. SOP-11.3 Personnel Hygiene & Visitor Policy is archived in the same transaction and is superseded by this program in full. Its dress code, jewellery list, visitor requirements, twelve-month retention and corrective-action clause are carried forward here; nothing it stated has been dropped.
