-- SOP-604 (Handheld Coder — TOAUTO HP-003) — activate and stamp approval metadata.
--
-- Transition the draft row to active and stamp it like the rest of the equipment docs:
-- effective_date 2026-06-01, approved_by 'GJM' (see 20260726000010/12/14/16).
--
