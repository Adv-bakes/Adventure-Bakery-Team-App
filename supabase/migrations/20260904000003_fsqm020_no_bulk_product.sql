-- FSQM-020: no bulk or unlabeled product ships. Part 7 becomes a scope statement. Still draft.
--
...
begin
  ...
  if r.lines <> 27 or r.steps <> 10 or r.bullets <> 8 or r.prose <> 9 then
    raise exception 'FSQM-020 wrong shape: % / % / % / % (expected 27 / 10 / 8 / 9).',
