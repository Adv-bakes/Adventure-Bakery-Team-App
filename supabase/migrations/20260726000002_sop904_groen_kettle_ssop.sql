  ...
  $json$
{
  ...
  "procedure": [
    ...
    "Sanitize (Noble Sani-512, no-rinse): after cleaning and draining, sanitize the food-contact surfaces with Noble Chemical Sani-512 mixed for food-contact use at 1:512 — 1 fl oz per 4 gallons of water (0.25 oz per gallon). Wet every food-contact surface and leave it for at least 1 minute, then let it air dry; Sani-512 is a no-rinse sanitizer at this dilution — do not rinse it off. Check the strength with a quat test strip and record the reading on FRM-912. Sanitize again just before the next use (the release step).",
