  ...
  public: {
    Tables: {
      ...
      costing: {
        ...
        Relationships: [
          {
            foreignKeyName: "costing_baked_good_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "costing_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
      ...
      formulas: {
        ...
        Relationships: [
          {
            foreignKeyName: "formulas_baked_good_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "formulas_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
      ...
      ingredient_specs: {
        ...
        Relationships: [
          {
            foreignKeyName: "ingredient_specs_ingredient_id_fkey"
      ...
      packaging: {
        ...
        Relationships: [
          {
            foreignKeyName: "packaging_baked_good_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "packaging_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
      ...
      products: {
        Row: {
          ...
          net_per_case: number | null
          net_per_case_unit: string | null
          net_per_pack: number | null
          net_per_pack_unit: string | null
          notes: string | null
          product_name: string
        ...
        Relationships: [
          {
            foreignKeyName: "Baked_Goods_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
      ...
      readiness: {
        ...
        Relationships: [
          {
            foreignKeyName: "readiness_baked_good_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "readiness_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
      ...
      shelf_life: {
        ...
        Relationships: [
          {
            foreignKeyName: "shelf_life_baked_good_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shelf_life_concept_id_fkey"
            columns: ["concept_id"]
            isOneToOne: false
            referencedRelation: "concepts"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      has_client_access: { Args: { _user_id: string }; Returns: boolean }
      has_role: {
        Args: {
