...
export function ConceptDialog({ open, onClose, concept }: ConceptDialogProps) {
  ...
  const handleSave = async () => {
    ...
    const dataToSave = {
      ...
      net_weight: formData.net_weight ? parseFloat(formData.net_weight as string) : null,
      unit_length: formData.unit_length ? parseFloat(formData.unit_length as string) : null,
      unit_width: formData.unit_width ? parseFloat(formData.unit_width as string) : null,
      unit_height: formData.unit_height ? parseFloat(formData.unit_height as string) : null,
